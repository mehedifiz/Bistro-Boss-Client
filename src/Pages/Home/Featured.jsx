...
const Featured = () => { 
    return (
        <div className=" featured-items bg-fixed text-white pt-8 my-20">
            ...
            <div className="md:flex justify-center items-center bg-slate-200 bg-opacity-20 pb-20 pt-12  px-11  md:px-36 ">
                <div>
                    <img  src={img} alt="" />
                </div>
                <div className="md:ml-10 font-Inter text-black">
                    ...
                    <button className="btn btn-outline border-0 border-b-4 text-black mt-5 border-black
                    "> ORDER NOW</button> 
                </div>
            </div>
